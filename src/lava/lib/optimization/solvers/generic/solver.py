...
class SolverConfig:
    ...
    keep_running: bool
        A boolean flag to preserve the solver runtime after it has been
        initialized.
    """
...
class OptimizationSolver:
    ...
    def __init__(self, problem: OptimizationProblem):
        ...
        self._config: SolverConfig = None
    ...
    def solve(self, config: SolverConfig = SolverConfig()) -> SolverReport:
        ...
        """
        self._config = self.check_and_return_config(config)
    ...
    def check_and_return_config(self, new_config: SolverConfig) -> SolverConfig:
        return new_config
    ...
    def _is_problem_discrete(self):
        return (
            hasattr(self._problem.variables, "discrete")
            and self._problem.variables.discrete.num_variables is not None
        )
    ...
    def _is_problem_continuous(self):
        return (
            hasattr(self._problem.variables, "continuous")
            and self._problem.variables.continuous.num_variables is not None
        )
