...
def main():
    ...
    # 4) since we saved all of our results to the relative path "./bayesian_tutorial_results/" you can go there to see all the plots, videos, and logs generated by the optimization system
